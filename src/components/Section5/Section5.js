  ...
  return (
    <section id='section5'>
      ...
      <div className='section1-div' id='div1-2'>
        <img className='circle-images' id='travel-img' src={require('../../assets/images/Section5/travel.svg')} />
      </div>
      <div className='section1-div' id='about-div1-3'>
        <img id='cooking-img' className='circle-images' src={require('../../assets/images/Section5/cool-lion.jpg')} />
      </div>
      <div className='section1-div' id='div1-4'>
        <img id='cooking-img' className='circle-images' src={require('../../assets/images/Section5/hiking.svg')} />
      </div>
    </section>
  )
}
