...
export const FunStuff = () => {
  return (
    <section id='FunStuff'>
      ...
      <div className='section1-div bottom-div' id='about-div1-1'>
        <img id='cooking-img' className='circle-images-bottom' src={require('../../assets/images/FunStuff/cooking.svg')} />
      </div>
      ...
      <div className='section1-div bottom-div' id='fun-stuff-div1-2'>
        <img className='circle-images-bottom' id='travel-img' src={require('../../assets/images/FunStuff/travel.svg')} />
      </div>
      <div className='section1-div bottom-div' id='about-div1-3'>
        <img id='cooking-img' className='circle-images-bottom' src={require('../../assets/images/FunStuff/cool-lion.jpg')} />
      </div>
      <div className='section1-div bottom-div' id='fun-stuff-div1-4'>
        <img id='cooking-img' className='circle-images-bottom' src={require('../../assets/images/FunStuff/hiking.svg')} />
      </div>
    </section>
  )
}
